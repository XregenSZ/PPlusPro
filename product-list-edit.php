    ...
    <section>
        ...
        <div class="info">
            <div class="login-container">
                ...
                ?>
                <form action="product-list-edit-db.php" method="post">
                    <div class="register-form">
                        <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                        <h3>ชื่อสินค้า</h3>
                        <input type="text" name="product_name" value="<?php echo $row['productName']; ?>" placeholder="Product Name" required> <br><br>
                        <h3>จำนวน</h3>
                        <input type="text" name="quantity" value="<?php echo $row['quantity']; ?>" placeholder="quantity" required> <br><br>
                        <h3>ราคา</h3>
                        <input type="text" name="price" value="<?php echo $row['price']; ?>" placeholder="Price" required> <br><br>
                        <textarea type="text" name="descripion" value="<?php echo $row['product_descripion']; ?>" placeholder="รายละเอียดสินค้า"></textarea><br><br>
                        <h3>รูปสินค้า</h3>
                        <img width="100" src="uploads/<?php echo $row['ImageName']?>" alt=""><br><br>
                        <h3>รหัส ประเภท</h3>
                        <input type="text" name="type_id" value="<?php echo $row['type_id']; ?>" placeholder="Type id" required> <br><br>
                        <input type="submit" name="pd-list-edit" value="update">
                    </div>
                </form>
            </div>
        </div>

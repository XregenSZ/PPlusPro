...
<body>
    <div class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-2">
                    <h1>ร้านจัดจำหน่าย <br>เครื่องมือ อุปกรณ์ช่าง <br>ทุกชนิด</h1>
                    <p>
                    <h3>ร้านพีพลัสโปร</h3><br>
                    เราเป็นร้านที่ ขายอุปกรณ์งานช่าง สามารถดูสินค้าได้ที่หน้าร้าน <br>มีสินค้าให้ดูหลากหลายชนิด
                    อุปกรณ์ช่างทั่วไป อุปกรณ์ไฟฟ้า หมวดหมู่ทั่วไป <br>หลอดไฟ ของใช้ในบ้าน รับประกันคุณภาพ
                    </p>
                </div>
                <div class="col-2">
                    <img src="tool_Img/engineers-tool.jpg">
                </div>
            </div>
        </div>
